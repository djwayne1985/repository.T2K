...
class navigator:
    def root(self):
        self.addDirectoryItem('Created by T2K', 'ShowChangelog', 'icon.png', 'DefaultFolder.png')
        ...
        self.addDirectoryItem('Join Our Facebook Group Called - T2K Builds Support Group', 'ShowChangelog', 'icon.png', 'DefaultFolder.png')
