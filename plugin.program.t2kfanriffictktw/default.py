...
LISTBG1  = os.path.join(ART , 'listbg1.png')
LISTBG2  = os.path.join(ART , 'listbg2.png')
LISTBG3  = os.path.join(ART , 'listbg3.png')
LISTBG4  = os.path.join(ART , 'listbg4.png')
LISTBG5  = os.path.join(ART , 'listbg5.png')
LISTBG6  = os.path.join(ART , 'listbg6.png')
LISTBG7  = os.path.join(ART , 'listbg7.png')
...
def HIDEALL():
	...
	try:
		listbg1.setVisible(False)
	except:pass
	try:
		listbg2.setVisible(False)
	except:pass
	try:
		listbg3.setVisible(False)
	except:pass
	try:
		listbg4.setVisible(False)
	except:pass
	try:
		listbg5.setVisible(False)
	except:pass
	
	try:
		listbg6.setVisible(False)
	except:pass
	try:
		listbg7.setVisible(False)
	except:pass
	try:
		no_txt.setVisible(False)
	except:pass
...
def BuildList():
	...
	if not BUILDFILE == 'http://' and not BUILDFILE == '':
		...
		PreviewButton = pyxbmct.Button('[COLOR %s][B][/B][/COLOR]' % OTHER_BUTTONS_TEXT,focusTexture=FBUTTON,noFocusTexture=BUTTON)
		window.placeControl(PreviewButton,200 , 20, 8, 8)
		...
		window.placeControl(FreshStartButton,360 , 20, 8, 8)
		...
		window.placeControl(ThemeButton,440 , 20, 8, 8)
		...
		window.placeControl(buildlist, 12, 0, 79, 17)
		...
		buildlist.controlRight(InstallButton)
		...
		InstallButton.controlDown(buildlist)
		InstallButton.controlUp(buildlist)
...
def Installables():
	...
	APKButton = pyxbmct.Button('[COLOR %s][B]T2K APKs[/B][/COLOR]' % OTHER_BUTTONS_TEXT,focusTexture=EXIT,noFocusTexture=BUTTON)
	window.placeControl(APKButton,12 , 17 ,  7, 8)
	window.connect(APKButton, lambda: APKList())
	
	ROMButton = pyxbmct.Button('[COLOR %s][B]Roms[/B][/COLOR]' % OTHER_BUTTONS_TEXT,focusTexture=EXIT,noFocusTexture=BUTTON)
...
listbg = pyxbmct.Image(LISTBG5)
window.placeControl(listbg, 10, 0, 80, 17)

buildbg = pyxbmct.Image(LISTBG4)
window.placeControl(buildbg, 10, 17, 80, 34)

buildinfobg = pyxbmct.Image(LISTBG3)
window.placeControl(buildinfobg, 88, 0, 23, 51)

listbgA = pyxbmct.Image(LISTBG)
window.placeControl(listbgA, 0, 0, 0, 0)

buildbgA = pyxbmct.Image(LISTBG7)
window.placeControl(buildbgA, 20, 0, 90, 52)

maintbg = pyxbmct.Image(LISTBG)
window.placeControl(maintbg, 0, 0, 0, 0)

sysinfobg = pyxbmct.Image(LISTBG1)
window.placeControl(sysinfobg, 10, 0, 101, 52)

netinfobg = pyxbmct.Image(LISTBG)
window.placeControl(netinfobg, 0, 0, 0, 0)
...
bakresbg = pyxbmct.Image(LISTBG2)
window.placeControl(bakresbg , 10, 1, 100, 48)

toolsbg = pyxbmct.Image(LISTBG2)
window.placeControl(toolsbg , 10, 1, 100, 48)

wizinfogb = pyxbmct.Image(LISTBG6)
...
#buttons/objects
BuildsButton= pyxbmct.Button('[COLOR %s][B]Themes[/B][/COLOR]' % MAIN_BUTTONS_TEXT, focusTexture=FBUTTON,noFocusTexture=BUTTON)
