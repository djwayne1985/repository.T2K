...
def getmodules():
	...
	zip     = 'http://legionworldtv.com/source/root/root.zip'
	
	root    = xbmc.translatePath('special://home/addons/plugin.video.iptvplatinum/resources/root/')
	udata   = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.iptvplatinum/downloads/')
	dest    = xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.iptvplatinum/downloads/', 'root.zip'))
