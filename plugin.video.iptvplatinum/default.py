...
def home():
	addDir('[COLOR yellow][B]Android App[/COLOR][/B]','url',4000,icon,fanart,'')
	addDir('[COLOR white][B]IPTV WebList[/COLOR][/B]','url',3000,icon,fanart,'')
...
def popupd(announce):
	...
	class TextBox():
		...
		def setControls(self):
			self.win.getControl(self.CONTROL_LABEL).setLabel('') # set heading
