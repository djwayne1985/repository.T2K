...
if current_time - auth_token_time > 7200:
    try:
        with s.cache_disabled():
            r = s.post(auth_url, data={"signature": app_signature, "cert": "4182751846"}, timeout=10)
...
def get_lb_media_url(relayer):
    ...
    headers = [
        ...
        a2b_hex("582d5265717565737465642d576974683d322e312e3234253230467265656d69756d").decode("utf-8"),
    ]
