...
player_user_agent = "mediaPlayerhttp/2.7 (Linux;Android 5.1) ExoPlayerLib/2.6.1"
...
token_url = "http://taptube.net/tvtap1/index_tvtappro.php?case=get_channel_link_with_token_latest"
list_url = "http://taptube.net/tvtap1/index_tvtappro.php?case=get_all_channels"
...
def list_channels(cat_id=None):
    ...
    for c in ch["msg"]["channels"]:
        if c["cat_id"] == cat_id:
            image = "http://taptube.net/tvtap1/{0}|User-Agent={1}".format(quote(c.get("img"), "/"), quote(user_agent))
