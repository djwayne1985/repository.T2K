...
----------------------------------------------------------
"""
table_id = "appNyfluH9vmIU3Lh"
table_name = "Live_Sports"
...
class Template_Movie_List(Plugin):
    ...
    def process_item(self, item_xml):
        if "<Live_Sports>" in item_xml:
            item = JenItem(item_xml)
            if "all" in item.get("Live_Sports", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_template_Live_Sports",
                    'url': "",
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
            ...
            elif "genre" in item.get("Live_Sports", ""):    
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_template_genre_Live_Sports",
                    'url': item.get("Live_Sports", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
                    'episode': "0",
...
@route(mode='open_template_Live_Sports')
def open_movies():
    xml = ""
...
@route(mode='open_template_genre_Live_Sports',args=["url"])
