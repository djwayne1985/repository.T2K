"""
    ...
    -------- These are the xml examples you place in your xml to call the plugin
          Make the tag relevant to your plugin. <Live_Music> is the example below-----

    Returns the Template Movie list-

    <dir>
    <title>Template Movie List</title>
    <Live_Music>all</Live_Music>
    </dir>
    ...
    <Live_Music>genre/Action</Live_Music>
    </dir>

    <dir>
    <title>Template Comedy Movies</title>
    <Live_Music>genre/Comedy</Live_Music>
    </dir>    
...
----------------------------------------------------------
"""
table_id = "apph7sCTiajycEyhm"
table_name = "Music_Channels"
...
class Template_Movie_List(Plugin):
    ...
    def process_item(self, item_xml):
        if "<Live_Music>" in item_xml:
            item = JenItem(item_xml)
            if "all" in item.get("Live_Music", ""):
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_template_Music_Channels",
                    'url': "",
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
            ...
            elif "genre" in item.get("Live_Music", ""):    
                result_item = {
                    'label': item["title"],
                    'icon': item.get("thumbnail", addon_icon),
                    'fanart': item.get("fanart", addon_fanart),
                    'mode': "open_template_genre_Music_Channels",
                    'url': item.get("Live_Music", ""),
                    'folder': True,
                    'imdb': "0",
                    'season': "0",
                    'episode': "0",
...
@route(mode='open_template_Music_Channels')
def open_movies():
    xml = ""
...
@route(mode='open_template_genre_Music_Channels',args=["url"])
